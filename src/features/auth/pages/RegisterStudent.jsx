                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Join Stage222 as a Student
                        </h1>
                        <p className="text-lg text-gray-600 mb-8">
                            Create your account to access internships and job opportunities in Mauritania.
                            Connect with employers and start your career journey.
                        </p>
                        <div className="hidden md:block">
                            ...
                            >
                                ...
                                <p className="text-gray-700">Access to 1000+ internships and jobs</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                <p className="text-gray-700">Connect with top employers</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                <p className="text-gray-700">Build your professional profile</p>
                            </motion.div>
                        </div>
                    </motion.div>
