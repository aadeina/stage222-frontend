...
const renderNestedStats = (key, value) => {
    ...
    if (value.by_role) {
        return (
            <div className="mt-2">
                <div className="text-xs font-semibold text-gray-500 mb-1">{t('admin.components.analyticsCards.byRole')}</div>
    ...
    return (
        <section className="max-w-7xl mx-auto w-full mt-8">
            ...
            <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">{t('admin.components.analyticsCards.platformAnalytics')}</h2>
                <span className="text-[#00A55F] text-2xl">📊</span>
            </div>
            <p className="text-gray-500 mb-8">{t('admin.components.analyticsCards.keyMetricsDescription')}</p>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 flex flex-col">
                    <div className="flex items-center gap-2 mb-2 group relative">
                        ...
                        <span className="font-bold text-lg text-gray-900">{t('admin.components.analyticsCards.growthTrends')}</span>
                        {/* Tooltip */}
                        <div className="absolute left-8 top-0 z-10 hidden group-hover:block group-focus:block bg-gray-900 text-white text-xs rounded px-3 py-2 shadow-lg w-56">
                            {t('admin.components.analyticsCards.growthTrendsTooltip')}
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 flex flex-col">
                    <div className="flex items-center gap-2 mb-2 group relative">
                        ...
                        <span className="font-bold text-lg text-gray-900">{t('admin.components.analyticsCards.engagement')}</span>
                        {/* Tooltip */}
                        <div className="absolute left-8 top-0 z-10 hidden group-hover:block group-focus:block bg-gray-900 text-white text-xs rounded px-3 py-2 shadow-lg w-56">
                            {t('admin.components.analyticsCards.engagementTooltip')}
                        </div>
                    </div>
                    <div className="border-b border-gray-100 mb-4"></div>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 flex flex-col">
                    <div className="flex items-center gap-2 mb-2 group relative">
                        ...
                        <span className="font-bold text-lg text-gray-900">{t('admin.components.analyticsCards.conversions')}</span>
                        {/* Tooltip */}
                        <div className="absolute left-8 top-0 z-10 hidden group-hover:block group-focus:block bg-gray-900 text-white text-xs rounded px-3 py-2 shadow-lg w-56">
                            {t('admin.components.analyticsCards.conversionsTooltip')}
                        </div>
                    </div>
                    <div className="border-b border-gray-100 mb-4"></div>
                    ...
                    <div className="mt-4 flex items-center gap-2 group relative">
                        <span className="text-gray-500 text-sm cursor-pointer" tabIndex={0} aria-label="Avg Days to First Post Info">{t('admin.components.analyticsCards.avgDaysToFirstPost')}</span>
                        ...
                        <div className="absolute left-0 top-8 z-10 hidden group-hover:block group-focus:block bg-gray-900 text-white text-xs rounded px-3 py-2 shadow-lg w-56">
                            {t('admin.components.analyticsCards.avgDaysToFirstPostTooltip')}
                        </div>
                    </div>
                </div>
                {/* Top Users Card */}
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 flex flex-col">
                    <div className="flex items-center gap-2 mb-2 group relative">
                        ...
                        <span className="font-bold text-lg text-gray-900">{t('admin.components.analyticsCards.topUsers')}</span>
                        {/* Tooltip */}
                        <div className="absolute left-8 top-0 z-10 hidden group-hover:block group-focus:block bg-gray-900 text-white text-xs rounded px-3 py-2 shadow-lg w-56">
                            {t('admin.components.analyticsCards.topUsersTooltip')}
                        </div>
                    </div>
                    <div className="border-b border-gray-100 mb-4"></div>
