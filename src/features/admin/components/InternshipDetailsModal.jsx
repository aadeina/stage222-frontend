        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        {/* Header */}
                        <div className="bg-gradient-to-r from-[#00A55F] to-emerald-600 px-6 py-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-emerald-100 text-sm">Review before approval or rejection</p>
                                    </div>
                                </div>
                                <button
                                    onClick={onClose}
                                ...
                                {internship.approval_status === 'pending' && (
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            ...
                                            disabled={loading}
                                            className="px-6 py-2 bg-[#00A55F] text-white rounded-lg hover:bg-[#008c4f] transition-colors font-medium disabled:opacity-50 flex items-center gap-2"
                                        >
